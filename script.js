...
const ITEMS = {
    moisture: [
        ...
        { level: 2, name: '스킨', icon: '🧴', image: '토너-removebg-preview.png' }, // 대체: 스킨 이미지 미존재 → 토너 사용
        { level: 3, name: '크림', icon: '🥣', image: '크림-removebg-preview.png' },
        { level: 4, name: '마스크팩', icon: '🎭', image: '마스크팩-removebg-preview.png' },
        { level: 5, name: '앰플', icon: '🧪', image: '앰플-removebg-preview.png' } // Max
    ],
    makeup: [
        { level: 1, name: '빨간가루', icon: '✨', image: null },
        { level: 2, name: '빨간물약', icon: '🍷', image: null },
        { level: 3, name: '틴트', icon: '💄', image: '틴트-removebg-preview.png' },
        { level: 4, name: '립밤', icon: '💋', image: '립밤-removebg-preview.png' },
        { level: 5, name: '립스틱', icon: '👄', image: '립스틱-removebg-preview.png' } // Max
    ]
};
